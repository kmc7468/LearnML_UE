...
namespace lml_ue
{
	...
	control::control()
	{
		if ((handle_ = CreateWindow(TEXT("static"), TEXT(""), WS_CHILD | WS_VISIBLE, 0, 0, 200, 100, nullptr, nullptr, instance, nullptr)) == nullptr)
			throw LML_UE_ERRORCODE_FAILED_TO_CREATE_CONTROL;
	}
